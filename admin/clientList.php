                    ...
                    <form action="addClient" method="post" id="addClientForm" enctype="multipart/form-data"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" pattern="[0-9]{6}" name="pincode" maxlength="6" placeholder= "eg.123456" required>
                            </div>
                            <div class="modal-header">
                            ...
                            <div class="form-group ">
                                ...
                                <input id="panCheck" type="text" class="form-control" name="pan" maxlength="10" style="text-transform:uppercase" placeholder = "eg.AAAAA0000A" required>
                            </div>
                            <div class="form-group ">
                                <label for="name">GST No.</label>
                                <input id="gstCheck" type="text" class="form-control" name="gst" maxlength="15" style="text-transform:uppercase" placeholder = "eg.07AAAAA0000A1Z5">
                            </div>
                            <div class="form-group ">
                                <label for="name">TAN No.</label>
                                <input id="tanCheck" type="text" class="form-control" name="tan" maxlength="10" style="text-transform:uppercase" placeholder = "eg.AAAA00000A">
                            </div>
                            <div class="form-group ">
                                <label for="name">CIN No.</label>
                                <input id="cinCheck" type="text" class="form-control" name="cin" maxlength="21" style="text-transform:uppercase" placeholder = "eg.L00000DL0000AAA000000">
                            </div>
                            <div class="form-group ">
