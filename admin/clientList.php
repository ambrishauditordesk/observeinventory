            ...
            <div class="card-deck font-counter-1">
                ...
                <div class="card bg-light border-primary">
                    <div class="card-body text-center">
                        ...
                        <h6 class="card-subtitle mb-2 text-primary">Audits</h6>
                ...
                <div class="card bg-light border-warning">
                    <div class="card-body text-center">
                        ...
                        <h6 class="card-subtitle mb-2 text-warning">Audits</h6>
                        <p class="text-warning"><?php $userId = $_SESSION['id'];
                ...
                <form method="post" action="editAClient">
                    <div class="modal-body">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" name="added_by_date" id="added_by_date" readonly
                                value="">
                        </div>
                        <div class="form-group ">
    ...
    $(document).on('click', '.editClient', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#editModal #cactive option[value=" + obj.active + "]").attr('selected',
                    'selected');
