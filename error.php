    ...
    <div id="wrapper" style="height: 100%; width: 100%">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <div class="container-fluid" style="height: 100%; justify-content: center">

                    <!-- 404 Error Text -->
                    <div class="text-center"
                        style="height: 100%; display: flex; justify-content: center; flex-direction: column">
                        <div class="error mx-auto" data-text="Error">Error</div>
                        <p class="lead text-gray-800 mb-5">Please contact your Company Admin!</p>
                        <p class="text-gray-500 mb-0">It looks like you entered into a wrong url.</p>
