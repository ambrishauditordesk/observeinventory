                        ...
                        elseif ($prog_id == 247){
                            ...
                            <div class="row">    
                                ...
                                <?php
                                    if(isset($_SESSION['role']) && !empty($_SESSION['role']) && $_SESSION['role'] != 5)
                                    {
                                        $checkAccountsLog = $con->query("select id from accounts_log where workspace_id = '$wid'");
                                        if($checkAccountsLog->num_rows > 0){
                                ?>
                                <div class="row d-flex justify-content-center">
                                    <?php
                                        $checkReviewStatus = $con->query("select count(signoff_prepare_log.id) total from signoff_prepare_log inner join user on signoff_prepare_log.user_id=user.id where workspace_id=".$wid." and prog_id=247")->fetch_assoc();
